...
import com.example.samsungnormalannualproject.R;
...
public class HashMapPreferences {
    public static void saveMap(Context context, String key, Map<String, String> inputMap){
        SharedPreferences pSharedPref = context.getSharedPreferences(context.getString(R.string.userSharedPreferencesKey), Context.MODE_PRIVATE);
        if (pSharedPref != null){
            Gson gson = new Gson();
